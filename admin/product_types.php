...
.admin-table {
    ...
    text-align: left;
    min-width: 600px; /* Tránh gãy bảng trên mobile */
}
    ...
    <div class="admin-two-col">
        <div class="card-box">
            <form method="post" action="">
                ...
                <div class="form-group">
                    <label>Tên loại <span class="required-mark">*</span></label>
                ...
                <button class="btn" type="submit" style="width: 100%; margin-top: 8px;">Lưu loại sản phẩm</button>
            </form>
        </div>
            ...
            <div class="table-responsive">
                <table class="admin-table">
                    ...
                    <?php if (empty($productTypes)): ?>
                        <tr>
                            <td colspan="5" style="text-align: center; padding: 30px; color: var(--text-muted);">
                                Chưa có loại sản phẩm nào. Hãy thêm mới ở form bên cạnh!
                            </td>
                        </tr>
                    <?php endif; ?>
                    ...
                    <?php foreach ($productTypes as $type): ?>
                        <tr>
                            <td><span class="badge-gray"><?= e($type['category_name']) ?></span></td>
                            <td><strong><?= e($type['name']) ?></strong></td>
                            <td style="color: var(--text-muted); font-size: 13px;"><?= e($type['slug'] ?? '') ?></td>
                            <td style="text-align: center;"><?= (int)$type['sort_order'] ?></td>
                            <td>
                                <a class="btn btn-danger" style="padding: 6px 12px; font-size: 12px; min-height: unset;" 
                                   ...
                                   href="<?= BASE_URL ?>/admin/product_types.php?delete=<?= (int)$type['id'] ?>">Xóa</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
